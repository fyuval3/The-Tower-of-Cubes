...
public class LevelSettings : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //GsList.Add(new GameSet(new Dictionary<string, float>() { { "TOWER_HEIGHT", 30f }, { "CUBE_ROOT_SCALE", 1f }, { "FORCE", 600f }, { "GRAVITY", 10f }, { "MASS", 10f }, { "SCALE_DECREASE_RATE", 0.95f }, { "MESSY", 0 } }));
    }
